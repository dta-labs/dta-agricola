...
const long config[] = {0, 2, 3, 12, 11, 0, 52, 625, 106, 168};
String lastNumber = config[9] < 1000 ? ("0" + (String) config[9]) : (String) config[9];
const String telefono = (String) config[6] + (String) config[7] + (String) config[8] + lastNumber;
