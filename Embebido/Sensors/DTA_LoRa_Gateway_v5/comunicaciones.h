...
String httpRequest(String strMeasurements, String strVoltages, String strQualities, bool setup) {
  ...
  gprs.print(F("&qu=[")); gprs.print(strQualities); gprs.print(F("]"));
...
void comunicaciones(String strMeasurements, String strVoltages, String strQualities, bool setup) {
  Serial.println(F("\nComunicación con el servidor"));
  setupGSM();
  String data = httpRequest(strMeasurements, strVoltages, strQualities, setup); 
