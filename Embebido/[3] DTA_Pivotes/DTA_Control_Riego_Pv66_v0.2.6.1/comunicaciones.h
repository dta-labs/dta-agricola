...
String getTelefono() {
  ...
  String result = getResponse(15, testComm); 
...
String httpRequest() {
  ...
  gprs.println(httpServer + telefono + param1 + param2 + param3 + param4 + param5 + param6 + param7 + param8 + param9 + param10 + param11 + param12 + param13);
  getResponse(25, true); 
  systemWatchDog();
