...
void setup() {
  ...
  Serial.println("R(Ohms)\t\tP(cb)\tRiego");
  Serial.println("________\t_____\t___________________________________");
  delay(100);
}
...
void loop() {
  ...
  WM1_CB = convertR2Cb(WM1_Resistance, default_TempC, cFactor);
  String riego = isIrrigationNeeded(abs(WM1_CB));

  Serial.print(WM1_Resistance); Serial.print("\t"); 
  Serial.print(abs(WM1_CB)); Serial.print("\t"); 
