...
sensors_event_t humidity_SHT4x, temp_SHT4x;
...
String createDataStr() {
  ...
  dataStr += comma;
  dataStr += String(humidity_SHT4x.relative_humidity, 0);
  dataStr += comma;
  dataStr += String(temp_SHT4x.temperature, 1);
  dataStr += comma;
...
void setSHTHeater(sht4x_heater_t heater) {
  ...
  //     Serial.print(F("No heater"));
  //     break;
  //   case SHT4X_HIGH_HEATER_1S: 
  //     Serial.print(F("High heat for 1 second"));
  //     break;
  //   case SHT4X_HIGH_HEATER_100MS: 
  //     Serial.print(F("High heat for 0.1 second"));
  //     break;
  //   case SHT4X_MED_HEATER_1S: 
  //     Serial.print(F("Medium heat for 1 second"));
  //     break;
  //   case SHT4X_MED_HEATER_100MS: 
  //     Serial.print(F("Medium heat for 0.1 second"));
  //     break;
  //   case SHT4X_LOW_HEATER_1S: 
  //     Serial.print(F("Low heat for 1 second"));
  //     break;
  //   case SHT4X_LOW_HEATER_100MS: 
  //     Serial.print(F("Low heat for 0.1 second"));
  //     break;
  // }
}
...
void readSHT() {
  // setSHTHeater(SHT4X_NO_HEATER);
  sensors_event_t h, t;
  sht4.getEvent(&h, &temp_SHT4x);
  // Serial.print(temp.temperature); Serial.print(F(" ")); 
  // Serial.print(humidity.relative_humidity); Serial.print(F(" ")); 
  // setSHTHeater(SHT4X_HIGH_HEATER_1S);
  // delay(1000);
  // setSHTHeater(SHT4X_NO_HEATER);
  Serial.print(F("« "));
  if (h.relative_humidity > 70 && temp_SHT4x.temperature < 25) {
    setSHTHeater(SHT4X_HIGH_HEATER_1S);
    Serial.print(F("Calentador activado."));
    delay(5000);
  } else {
    setSHTHeater(SHT4X_NO_HEATER);
    Serial.print(F("Calentador desactivado."));
  }
  Serial.println(F(" »"));
  delay(5000);
  sht4.getEvent(&humidity_SHT4x, &t);
}
