...
#define vSueloSeco 2815
#define vSueloCC 1425
...
void getMoisture() {
  ...
  float valor = value / 1000;
  // float percent = constrain(map(value, valAire, valAgua, 38.0, 100.0), 0, 100);
  float percent = constrain(map(value, vSueloSeco, vSueloCC, 0.0, 31.6), 0.0, 100.0);
  Serial.println("Vcc: " + String(volt) + " ADC: " + String(val) + " Valor: " + String(valor, 3) + "V ~> " + String(percent, 1) + "%");
}
