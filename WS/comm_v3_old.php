<?php
	...
	if ($_GET["st"] && ($_GET["st"] == "ON" || $_GET["st"] == "OFF")) {
		...
		$dataUpdate .= ',"message":"st:' . $_GET["st"];
		$dataUpdate .= ",di:" . $_GET["di"]; 
		$dataUpdate .= ",sa:" . $_GET["sa"]; 
		$dataUpdate .= ",vo:" . $_GET["vo"]; 
		$dataUpdate .= ",sp:" . $_GET["sp"];
		$dataUpdate .= ",pr:" . $_GET["pr"];
		$dataUpdate .= ",po:" . $_GET["po"];
		$dataUpdate .= ",la:" . $_GET["la"];
		$dataUpdate .= ",lo:" . $_GET["lo"];
		$dataUpdate .= ",er:" . $_GET["er"];
		$dataUpdate .= ",si:" . $_GET["si"];
		$dataUpdate .= ",ar:" . $_GET["ar"]; 
		$dataUpdate .= ",rx:" . $_GET["rx"] . '"'; 
